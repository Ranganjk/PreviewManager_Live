                ...
                <asp:Panel ID="pnlStatTat" runat="server" Visible="false">
                    ...
                    <tr style="vertical-align: top;">
                        ...
                        <td>
                            ...
                            <asp:Label ID="Label3" runat="Server" Text="Total number of case id's (Current month) = Open + Upl.Current Month + BIR-Current Month + Cancelled-Current Month" Font-Bold="false" ForeColor="Black" Font-Underline="false" Font-Names="Verdana" Font-Size="X-Small"></asp:Label>
                        </td>
                        <td style="width: 20px"></td>
                        <td>
